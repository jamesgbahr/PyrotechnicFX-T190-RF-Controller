...
cd /d "%~dp0"
title PyrotechnicFX T190 Receiver Full Flash v1.6.3
...
findstr /I /L /C:"[env:t190_receiver]" "platformio.ini" >nul
if errorlevel 1 goto :wrong_folder

set "PIO_ENV=t190_receiver"

echo.
echo ============================================================
echo  PyrotechnicFX T190 RECEIVER Full Flash v1.6.3
echo ============================================================
echo Project:      %CD%
...
echo.
echo STEP 1 OF 3: Building receiver firmware...
...
echo.
echo ============================================================
echo  RECEIVER FULL FLASH COMPLETED SUCCESSFULLY
echo ============================================================
echo.
...
echo.
echo ============================================================
echo  WRONG FOLDER FOR RECEIVER SCRIPT
echo ============================================================
echo Put this BAT directly in the PFX-RX folder that contains:
echo   platformio.ini
echo   src\main.cpp
echo.
